...
4. `sprints/sprint-001/requirements.md` — your task, and specifically the
   "Honest starting point" section. What is not in it is not established.
5. `sprints/sprint-001/blueprint.md` — the phases, in order, each with its
   rollback.
6. `sprints/sprint-001/acceptance-criteria.md` — how you will be graded,
...
`sprints/sprint-001/acceptance-criteria.md`, fully ticked under Outcome A or
