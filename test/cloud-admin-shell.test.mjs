...
test('authenticated shell navigation names real product surfaces and remains role-aware', () => {
  ...
  assert.match(script, /Control surface unavailable: authenticated storage\/readiness is not configured/iu);
